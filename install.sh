...
# Project name : Termux-Redoupshack
# Coded by: Redoupshackeur (You dont become a coder by just changing the credits)
...
echo -e "\e[033m" "For More Awesome and Useful Tool like this Visit My website ©www.Redoups.Hackeur"
